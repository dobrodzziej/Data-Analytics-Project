...
namespace generated_quantities_model_namespace {
...
{" (found before start of program)",
 ...
 " (in 'C:/Studia/Data-Analytics/Projekt-Proper/generated_quantities.stan', line 10, column 13 to column 14)",
 " (in 'C:/Studia/Data-Analytics/Projekt-Proper/generated_quantities.stan', line 16, column 13 to column 14)"};




class generated_quantities_model final : public model_base_crtp<generated_quantities_model> {
 ...
 public:
  ~generated_quantities_model() { }
  
  inline std::string model_name() const final { return "generated_quantities_model"; }
  ...
  generated_quantities_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "generated_quantities_model_namespace::generated_quantities_model";
    ...
    try {
      ...
      stan::math::validate_non_negative_index("y_l", "N", N);
      current_statement__ = 14;
      stan::math::validate_non_negative_index("y_p", "N", N);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "generated_quantities_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "generated_quantities_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
    ...
    try {
      ...
      stan::model::assign(y_l,
        stan::math::normal_rng(
          stan::math::add(alpha_l, stan::math::multiply(x, beta_l)), sigma_l,
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__ = std::vector<std::string>{"alpha_l", "beta_l", "sigma_l", "y_l",
      "alpha_p", "beta_p", "gamma", "sigma_p", "y_p"};
  ...
  inline void constrained_param_names(
    ...
    if (emit_generated_quantities__) {
      param_names__.emplace_back(std::string() + "alpha_l");
      param_names__.emplace_back(std::string() + "beta_l");
      param_names__.emplace_back(std::string() + "sigma_l");
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        {
          param_names__.emplace_back(std::string() + "y_l" + '.' + std::to_string(sym1__));
        } 
      }
      param_names__.emplace_back(std::string() + "alpha_p");
      param_names__.emplace_back(std::string() + "beta_p");
      param_names__.emplace_back(std::string() + "gamma");
      param_names__.emplace_back(std::string() + "sigma_p");
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        {
  ...
  inline std::string get_constrained_sizedtypes() const {
    ...
    return std::string("[{\"name\":\"alpha_l\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"beta_l\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"sigma_l\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"y_l\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"generated_quantities\"},{\"name\":\"alpha_p\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"beta_p\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"gamma\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"sigma_p\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"y_p\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"generated_quantities\"}]");
...
using stan_model = generated_quantities_model_namespace::generated_quantities_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return generated_quantities_model_namespace::profiles__;
}
